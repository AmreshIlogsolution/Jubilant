  ...
  <div class="bg-blue w-full p-2 flex justify-center font-sans">
    <div class="rounded bg-grey-light p-2 bg-blue-500 w-screen">
      ...
      <div class="overflow-x-auto relative">
        ...
        >
          ...
          <div class="flex justify-between py-1 bg-blue-800">
            <h6 class="text-sm text-white">Bin to Location Trans.</h6>
            <label
              for="default-toggle"
            ...
            >
              ...
              ></div>
              <span class="pr-1 text-sm font-medium text-white"
                >Use HHT Device</span
              >
            </label>
          </div>
      ...
      <div class="bg-white p-2 rounde2remd mt-1 border-b border-grey h-22">
        <div
          class="grid grid-flow-row-dense grid-cols-4 gap-1"
          v-if="searchDiv"
        >
        ...
        <div class="grid grid-flow-row-dense grid-cols-4 gap-3" v-if="scanDiv">
          <div class="col-span-2" v-if="!hht">
            ...
            <input
              ...
              v-model="scanSkuNo"
              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              @keyup.enter="scanBinSkuTransfer()"
            />
          </div>
