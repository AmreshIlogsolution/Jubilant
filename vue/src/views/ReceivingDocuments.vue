  ...
  <div class="bg-blue w-full p-2 flex justify-center font-sans">
    <div class="rounded bg-grey-light p-2 bg-gray-300 w-screen">
      <div class="flex justify-between py-1">
        <h3 class="font-bold text-indigo-700">Upload Documents</h3>
        <button
          @click="$router.back()"
      ...
      <div class="bg-white p-2 rounded mt-1 border-b border-grey h-90">
        <div class="grid grid-flow-row-dense">
          <form enctype="multipart/form-data" @submit="submitForm">
            <div v-if="success != ''">
              <span
                class="flex items-center justify-between py-3 px-5 bg-green-500 text-white rounded"
                >{{ success }}
              </span>
            </div>
...
<img :src="vehicleImgSrc"/> -->
            ...
            <div class="flex">
              <div class="w-3/4">
                <label
                  ...
                  class="block text-sm font-medium text-red-700 float-left ml-2"
                >
                  Vehicle Seal Image(*)</label
                >
                <input
                  type="file"
                  name="vehicleSealImage"
                  id="vehicleSealImage"
                  v-on:change="vehicleSealImagechange"
                  class="block w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                  aria-describedby="vehicleSealImage"
                />
              </div>
            ...
            <div class="flex ...">
              <div class="w-3/4">
                ...
                <input
                  type="file"
                  name="vehicleNoPlateImage"
                  id="vehicleNoPlateImage"
                  v-on:change="vehicleNoPlateImagechange"
                  class="block w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                />
              </div>
              ...
              <div class="w-1/4" id="preview">
                <img
                  v-if="vehicleNoPlateImageurl"
                  :src="vehicleNoPlateImageurl"
                />
              </div>
            </div>
            ...
            <div class="flex ...">
              <div class="w-3/4">
                ...
                <input
                  type="file"
                  name="materialLoadedone"
                  v-on:change="MaterialImgOnefilechange"
                  id="materialLoadedone"
                  class="block w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                />
              </div>
              <div class="w-1/4" id="preview">
            ...
            <div class="flex">
              <div class="w-3/4">
                ...
                <input
                  type="file"
                  name="materialLoadedtwo"
                  id="materialLoadedtwo"
                  v-on:change="MaterialImgTwofilechange"
                  class="block w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                />
              </div>
              <div class="w-1/4" id="preview">
            ...
            <div class="flex">
              <div class="w-3/4">
                ...
                <input
                  type="file"
                  name="materialLoadedthree"
                  v-on:change="MaterialImgThreefilechange"
                  id="materialLoadedthree"
                  class="block w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                />
              </div>
              ...
              <div class="w-1/4" id="preview">
                <img
                  v-if="materialLoadedthreeurl"
                  :src="materialLoadedthreeurl"
                />
              </div>
            ...
            <div>
              ...
              <button
                class="bg-slate-500 hover:bg-slate-700 hover:text-white text-white py-1 px-3 rounded outline outline-offset-2 outline-slate-500 mt-6 w-full"
                type="submit"
              >
                Upload
              </button>
      ...
      <!-- <p class="mt-3 text-white">
        <router-link v-on:click.native="doSomethingCool" to="/"
          >Home</router-link
        >
...
export default {
  ...
  methods: {
    ...
    async submitForm(e) {
      ...
      axiosClient
        .post("/uploads-received-documents", data, config)
        .then((res) => {
